...
export default function Hero() {
    ...
    return (
            <section id='hero' className=''>
                ...
                <div className='relative col-span-1 h-full min-h-[200px] w-full sm:min-w-[300px] overflow-hidden shadow-xl shadow-black/40 sm:rounded-r-3xl'>
                    <img className='object-cover w-full h-full' alt='Edgar-Image' decoding='async' sizes='full' src='img1.jpg' />
                </div>
                <div className='relative col-span-1 sm:-ml-4 sm:mr-4 sm:py-6 md:-ml-8 md:mr-8 md:py-12'>
                    ...
                    <div className='relative mb-4 flex flex-row  flex-wrap items-center'>
                        ...
                        &gt;
                        <span className='font-medium text-stone-400'>Welcome to my webpage!</span>
                        &lt;/
                        <span className='font-bold text-green-600'>code</span>
                        &gt;
                        </p>
